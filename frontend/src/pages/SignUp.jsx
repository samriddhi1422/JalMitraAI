...
import { Droplets, Mail, Lock, User, AlertCircle, CheckCircle } from 'lucide-react';
...
if (!data.success) {
  ...
  return (
    <div> <div className="min-h-screen bg-gradient-to-br from-teal-50 via-white to-blue-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Start analyzing your rainwater harvesting potential</p>
        </div>
