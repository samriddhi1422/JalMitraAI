  ...
  return (
    <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          ...
          <div className="flex gap-4">
            ...
            <button
              ...
              className="px-6 py-2 bg-teal-600 text-white rounded-lg hover:bg-teal-700 transition-all shadow-md hover:shadow-lg font-medium hidden sm:block"
            >
              Start Analysis
            </button>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
        ...
        <p className="text-l md:text-xl text-gray-600 mb-10 max-w-3xl mx-auto">
        ...
        <div className="flex-col gap-8 justify-center sm:flex-row  ">
          <button
            onClick={ ()=> navigate('/signup')}
          ...
          <button
             onClick={()=>  navigate('/login')}
            className="px-8 py-4 bg-white text-teal-600 rounded-lg hover:bg-gray-50 transition-all shadow-lg border-2 border-teal-600 font-semibold text-lg mt-2 ml-3"
          >
            Login
          </button>
        </div>
